...
import { ArrowLeft, Barcode, Camera, Image as ImageIcon, Keyboard, Loader2, Save, Wand2, Plus, Trash2, Upload } from 'lucide-react';
    ...
    const startCamera = async () => {
      try {
        ...
        const scanLoop = async () => {
          ...
          // 1. Apple Vision / Android Native Hardware BarcodeDetector
          if (nativeDetector) {
            try {
